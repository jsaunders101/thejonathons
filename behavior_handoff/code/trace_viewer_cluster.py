...
Usage:
  python trace_viewer_cluster.py "/path/to/run"                    # motion energy
  python trace_viewer_cluster.py "/path/to/run" --trace intensity  # mean fluorescence
...
class Viewer:
    def __init__(self, run, trace_kind="motion", ds=2, fps=15):
        ...
        self.fig.canvas.manager.set_window_title(
            f"trace_viewer_cluster — {run.name} [{trace_kind}]")
